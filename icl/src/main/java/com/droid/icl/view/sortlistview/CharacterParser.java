 ...
 * @version	0.1
 */
package com.droid.icl.view.sortlistview;
...
public class CharacterParser {
    ...
    public static String getSortLetters(String name) {
        ...
        try {
            for (int i = 0; i < t0; i++) {
                ...
                if (Character.toString(t1[i]).matches("[\\u4E00-\\u9FA5]+")) {
                    ...
                    t4 += Character.toString(t1[i]);// 如果不是汉字字符，直接取出字符并连接到字符串t4后
                }
            }
//            System.out.println(t4);
    ...
    public static String getPinYinHeadChar(String str) {
        ...
        if (TextUtils.isEmpty(convert))
            return "#";
        // 正则表达式，判断首字母是否是英文字母
        convert = convert.substring(0, 1).toUpperCase();
